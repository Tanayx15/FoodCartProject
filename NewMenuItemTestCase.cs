...
using Moq;
using FoodCart_Hexaware.Data; // Adjust as necessary
using FoodCart_Hexaware.Models; // Adjust as necessary
...
public class MenuItemRepositoryTests
{
    ...
    public void SetUp()
    {
        ...
        _testMenuItem = new MenuItem { Id = 1, Name = "Pizza", Price = 150 };
    }
